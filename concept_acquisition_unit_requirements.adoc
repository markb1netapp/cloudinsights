...
* CentOS (64-bit): 7.2 through 7.9, CentOS 8 Stream
...
Note: CentOS 8.x support is being replaced with CentOS 8 Stream support. CentOS 8.x will reach End-of-Life on December 31, 2021.
